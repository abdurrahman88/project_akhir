          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Tambah Kategori <small>sub title</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form action="proses/proses_edit_kategori.php" method="post" class="form-horizontal form-label-left" novalidate>
                      
                      <span class="section">Info Penambahan Kategori</span>
                      <?php
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" value="<?= $row['judul'] ?>" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="judul" placeholder="Masukan nama anda.." required="required" type="text">
                        </div>
                      </div>
