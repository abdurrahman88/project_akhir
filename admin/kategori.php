                ...
                <div class="x_panel">
                  ...
                  <div class="x_content"> 
                    <div class="btn btn-primary pull-left">
                      <a href="tambah_kategori.php" style="color: white;">Tambah Kategori</a>
                    </div>
                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                          echo "
                            <tr>
                              ...
                              <td>".$row['judul']."</td>
                              <td>
                                  <a class='btn btn-info btn-xs' href='edit_kategori.php?ID=$row[id]'>
                                    <i class='fa fa-pencil'></i>Change
                                  </a>
                                  <a class='btn btn-danger btn-xs' href='proses/proses_hapus_kategori.php?ID=$row[id]'>
